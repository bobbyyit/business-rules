...
import static com.yit.business.services.CommissionService.generateCommissionPayment;
...
import static com.yit.business.services.PackageSlipGenerator.generateCustomPackagingSlipFor;
...
public class PaymentAction {
    ...
    public String apply(Payment payment) {
        ...
        if (payment.getProduct() == PHYSICAL) {
            ...
            messages.add(generateCommissionPayment());
            ...
            messages.add(generatePackagingSlipFor(payment.getFrom()));
            messages.add(generateCustomPackagingSlipFor("Ski video", payment.getFrom()));
        }
